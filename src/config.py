...
DEBUG_MODE = 0 #IMP!!! Disable this on production 0/1
...
ENABLE_DATA_LOGGING = 0 #1 to enable logging in case of no Server connection. 0 to Disable
...
ClientId = "6ded3590-d226-11e4-9b03-bc764e102b63"
...
#Add serial ports to local serial port list
